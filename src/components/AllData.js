...
import Img24 from "../img/products/24.jpg";
import Img25 from "../img/products/25.jpg";
import Img26 from "../img/products/26.webp";
import Img29 from "../img/products/29.jpg";
import Img30 from "../img/products/30.jpg";
...
import VintageLamp1 from "../img/products/otherProducts/VintageLamp1.webp";
import VintageLamp2 from "../img/products/otherProducts/VintageLamp2.jpg";
import WirelessHeadphones1 from "../img/products/otherProducts/WirelessHeadphones1.jpg";
import WirelessHeadphones2 from "../img/products/otherProducts/WirelessHeadphones2.webp";
import VelvetChair1 from "../img/products/otherProducts/VelvetChair1.jpg";
import VelvetChair2 from "../img/products/otherProducts/VelvetChair2.webp";
import FacialCleanser1 from "../img/products/otherProducts/FacialCleanser1.jpg";
import FacialCleanser2 from "../img/products/otherProducts/FacialCleanser2.webp";
import CookwareSet1 from "../img/products/otherProducts/CookwareSet1.jpg";
import CookwareSet2 from "../img/products/otherProducts/CookwareSet2.jpg";
import OfficeChair1 from "../img/products/otherProducts/OfficeChair1.webp";
import OfficeChair2 from "../img/products/otherProducts/OfficeChair2.webp";
...
export const items = [
  ...
  },
  {
    ...
    categ4ry: "lamp",
    img: Img21,
    descripti4n: "Vintage Brass Desk Lamp",
    price: 110,
    otherImgs: [VintageLamp1, VintageLamp2],
    specs:
      "A vintage-inspired brass desk lamp that adds a touch of elegance to your workspace or reading nook. The adjustable arm allows you to direct light where you need it. The perfect blend of classic and modern design.",
    texture: "Brass",
    weight: "3kg",
    size: "30cm x 15cm",
  },
  {
    ...
    price: 199,
    otherImgs: [WirelessHeadphones1, WirelessHeadphones2],
    specs:
      "Immerse yourself in music with these wireless noise-canceling headphones. They deliver crystal-clear sound and are perfect for travel or blocking out distractions.",
    texture: "Plastic/Metal",
    weight: "0.5kg",
    size: "20cm x 10cm",
  },
  {
    ...
    price: 299,
    otherImgs: [OfficeChair1, OfficeChair2],
    specs:
      "Stay comfortable during long workdays with this ergonomic office chair. It features adjustable lumbar support and a breathable mesh back for maximum comfort and productivity.",
    texture: "Mesh/Fabric",
    weight: "15kg",
    size: "65cm x 55cm",
  },
  {
    ...
    price: 199,
    otherImgs: [CookwareSet1, CookwareSet2],
    specs:
      "Upgrade your kitchen with this high-quality stainless steel cookware set. It includes pots, pans, and lids, perfect for all your cooking needs. Durable and easy to clean.",
  ...
  },
  {
    ...
    price: 24,
    otherImgs: [FacialCleanser1, FacialCleanser2],
    specs:
      "Care for your skin with this organic facial cleanser. It gently removes impurities, leaving your skin feeling refreshed and rejuvenated. Suitable for all skin types.",
    texture: "Liquid",
    weight: "150ml",
    size: "12cm x 4cm",
  },
  {
    ...
    category: "chair",
    img: Img30,
    description: "Velvet Accent Chair",
    price: 149,
    otherImgs: [VelvetChair1, VelvetChair2],
    specs:
      "Elevate your living space with this luxurious velvet accent chair. Its elegant design and soft upholstery make it the perfect addition to your home decor.",
    texture: "Velvet/Wood",
    weight: "10kg",
    size: "70cm x 60cm",
  },
